...
//                        ToastUtils.showToast("云端系统RRPC下行响应失败");
            ...
            } else if (ConnectSDK.getInstance().getPersistentConnectId().equals(connectId) && !TextUtils.isEmpty(topic) && topic.startsWith("/sys/" + RemotePaymentApplication.productKey + "/" + RemotePaymentApplication.deviceName + "/rrpc/request/")) {
                ...
                LinkKit.getInstance().publish(request, new IConnectSendListener() {
                    ...
                    topic.startsWith("/sys/" + RemotePaymentApplication.productKey + "/" + RemotePaymentApplication.deviceName + "/broadcast/request/")) {
                /**
                ...
                //TODO 根据批量广播做业务逻辑处理
                    ...
                    topic.startsWith("/broadcast/" + RemotePaymentApplication.productKey )) {
                //
                /**
