...
import com.gaozhao.remote.aliyun.alink.devicesdk.adapter.EventListAdapter;
import com.gaozhao.remote.aliyun.alink.devicesdk.adapter.PropertyListAdapter;
    ...
    private void parseIntent() {
        ...
        try {
            if (intent == null || intent.getExtras() == null){
                ...
                productKey = RemotePaymentApplication.productKey;
                deviceName = RemotePaymentApplication.deviceName;
                isSubDev = false;
                return;
            }
            productKey = intent.getExtras().getString("pk", RemotePaymentApplication.productKey);
            deviceName = intent.getExtras().getString("dn", RemotePaymentApplication.deviceName);
